...
public:
    //used by blocklist class
    std::vector<GLuint> VBOList;
    std::vector<GLuint> IndexCount;
    std::vector<bool> VBOBound;
    std::vector<GLuint> VBOIndexList;
    ...
    std::vector<GLuint> bufUV;
    std::vector<bool> UVBound;

    GLuint VBO_handle;
    GLuint IndexVBO_handle;
    int VBOindex_count;
    bool General_VBOBound;
...
public:
    ...
    void generateChunkVBO();
    void generateChunkVBOIndex();
    bool BindChunkVBO();
    bool BindChunkVBOIndex();

    void generateGeneralVBOs(int IndexVBO_size);
    bool bindGeneralVBO();

    void generateNewUVs(GLuint index);
    void RegenerateNewUVs(GLuint index);
    void DeleteUVsHandle(GLuint index);

    void generateNewVBO(GLuint index);
    void RegenerateNewVBO(GLuint index);
    void DeleteVBOHandle(GLuint index);
    void generateNewVBOIndex(int index);
    void RegenerateNewVBOIndex(int index);
    void DeleteVBOIndex(int index);
    bool bindVBO(int index);
